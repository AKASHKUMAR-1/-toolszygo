...
const categories = [
  {
    ...
    tools: [
      ...
      { name: 'SIP Calculator', slug: 'sip-calculator', built: false },
      { name: 'FD Calculator', slug: 'fd-calculator', built: false },
      ...
      { name: 'Compound Interest Calculator', slug: 'compound-interest-calculator', built: false },
      { name: 'Simple Interest Calculator', slug: 'simple-interest-calculator', built: false },
      ...
      { name: 'Discount Calculator', slug: 'discount-calculator', built: false },
  ...
  },
  {
    ...
    tools: [
      ...
      { name: 'Color Code Picker (HEX/RGB/HSL)', slug: 'color-code-picker', built: false },
      { name: 'Lorem Ipsum Generator', slug: 'lorem-ipsum-generator', built: false },
      { name: 'CSS/JS/HTML Minifier', slug: 'code-minifier', built: false },
      { name: 'URL Encoder / Decoder', slug: 'url-encoder-decoder', built: false },
      { name: 'Regex Tester', slug: 'regex-tester', built: false },
      { name: 'JSON Formatter / Validator', slug: 'json-formatter', built: false },
      { name: 'UUID Generator', slug: 'uuid-generator', built: false },
    ],
  },
  {
    name: 'Text Tools',
